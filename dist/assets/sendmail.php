<?php
    ...
    $to_email       = "mail@bs-consult.pro";           // Email получателя отчетов, например: 'admin@mysite.ru'
    ...
    $subject        = "[BS-Consult]";                  // Название сайта в квадратных скобках для подстановки в тему письма префиксом
